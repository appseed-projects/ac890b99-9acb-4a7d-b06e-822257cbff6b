...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-13 19:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ac890b99-9acb-4a7d-b06e-822257cbff6b.git
$ cd ac890b99-9acb-4a7d-b06e-822257cbff6b
```
